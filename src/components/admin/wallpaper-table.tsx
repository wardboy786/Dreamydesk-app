...
// The Wallpaper type might be augmented with range-specific counts from analytics
type DisplayWallpaper = Wallpaper & { downloadCount?: number };
                ...
                {showDownloads && (
                  <TableCell className="text-right font-bold">
                     <div className="flex items-center justify-end gap-1">
                      ...
                      {/* Use range-specific downloadCount if available, otherwise fallback to total downloads */}
                      {wallpaper.downloadCount !== undefined ? wallpaper.downloadCount : wallpaper.downloads}
                    </div>
                  </TableCell>
                )}
                {showLikes && (
